      ...
      menu: [
        ...
        },
        {
          ...
          subMenus: [
            ...
            {
              menuValue: 'Eliminar perosnal',
              route: '',
              base: '',
              permision: 'Eliminar Personal',
              show_nav: false,
            },
            // {
        ...
        },
        {
          ...
          subMenus: [
            ...
            {
              menuValue: 'Eliminar Pagos Pagos',
              route: '',
              base: '',
...

        {
          ...
          menuValue: 'Certificado',
          hasSubRoute: true,
          showSubRoute: false,
          faIcon: true,
          img: 'assets/img/icons/certificados.svg',
          base: '', 
          route: '', 
          subMenus: [
            {
              menuValue: 'Subir certificado',
